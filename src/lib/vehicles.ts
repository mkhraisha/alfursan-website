...
export const PUBLIC_COLUMNS =
  "vin, make, model, trim, series, year, colour, odometer, advertised_price_cargurus, images_json, videos_json, carfax_link, drive_type, transmission, fuel_type, cylinders, doors, features, description";
