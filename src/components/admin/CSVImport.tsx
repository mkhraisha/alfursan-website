...
const VEHICLE_FIELDS: { value: string; label: string }[] = [
  ...
  { value: "drive_type",         label: "Drive Type (fwd/rwd/awd/4wd)" },
  { value: "transmission",       label: "Transmission (automatic/manual/cvt)" },
  { value: "fuel_type",          label: "Fuel Type (gasoline/diesel/hybrid/electric)" },
